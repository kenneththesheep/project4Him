...
users.each do |user|
  10.times do |n|
    user.inventory.create({name: FFaker::Product.product ,remarks: FFaker::Lorem.paragraph, total_quantity: 0, unsorted_quantity:0, sorted_quantity:0, category: "others"
     })
  end
end