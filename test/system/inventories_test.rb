...
class InventoriesTest < ApplicationSystemTestCase
  ...
  test "creating a Inventory" do
    ...
    fill_in "Image url", with: @inventory.image_url
    fill_in "Name", with: @inventory.name
    fill_in "Remarks", with: @inventory.remarks
    fill_in "Sorted quantity", with: @inventory.sorted_quantity
    fill_in "Total quantity", with: @inventory.total_quantity
    fill_in "Unsorted quantity", with: @inventory.unsorted_quantity
